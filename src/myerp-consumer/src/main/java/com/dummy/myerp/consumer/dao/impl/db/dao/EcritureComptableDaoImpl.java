...
public class EcritureComptableDaoImpl extends AbstractDbConsumer implements IEcritureComptableDao {


	private final static EcritureComptableDaoImpl INSTANCE = new EcritureComptableDaoImpl();

	protected EcritureComptableDaoImpl() {
		super();
	}

	public static EcritureComptableDaoImpl getInstance() {
		return EcritureComptableDaoImpl.INSTANCE;
	}
